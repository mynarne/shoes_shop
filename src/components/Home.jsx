    ...
    return (
        <>
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-6">
                ...
                <button className="border border-gray-500 text-gray-500 hover:bg-gray-500 hover:text-white font-medium text-sm px-4 py-2 rounded transition-colors active:bg-gray-600"
                onClick={()=>{sort('asc')}}>
                    낮은가격순 정렬
                </button>

                <button className="border border-green-600 text-green-600 hover:bg-green-600 hover:text-white font-medium text-sm px-4 py-2 rounded transition-colors active:bg-green-700"
                onClick={()=>{sort('desc')}}>
                    높은가격순 정렬
                </button>
            </div>
            ...
            <div className="flex justify-center my-6">
                <button className="border border-green-600 text-green-600 hover:bg-green-600 hover:text-white font-medium text-sm px-5 py-2.5 rounded-lg transition-colors active:bg-green-700  shadow-sm" 
                onClick={moreNike}>
                    + 3개 상품 더 보기
                </button>
            </div>
